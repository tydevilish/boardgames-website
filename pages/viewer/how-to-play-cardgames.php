...
<head>
    ...
    <title>วิธีการเล่นการ์ดเกม - Board & Card Game</title>
...
<body class="bg-blue-50 font-sans flex flex-col min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div class="text-center">
                ...
                <p class="text-xl text-blue-100 max-w-2xl mx-auto" style="font-family: 'Kanit', sans-serif;">
                    เรียนรู้กฎและวิธีการเล่นการ์ดเกมแต่ละเกมอย่างละเอียด เพื่อความสนุกสนานในการเล่นกับเพื่อนและครอบครัว
                </p>
            </div>
        </div>
    </section>
    ...
    <section class="py-16 px-4 bg-gray-50">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 gap-12">
                <?php
                $stmt = $conn->query("SELECT * FROM how_to_play_cardgames WHERE status = 'published' ORDER BY created_at DESC");
    ...
    <script>
        ...
        function showFullContent(id) {
            fetch(`../../actions/get-how-to-play-cardgame.php?id=${id}`)
