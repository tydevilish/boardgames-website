...
<head>
  ...
  <title>แนะนำการ์ดเกม - Board & Card Game</title>
  ...
  <section class="py-24 px-4 mt-16">
    <div class="max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 gap-12">
        <?php
        $stmt = $conn->query("SELECT * FROM cardgames WHERE status = 'published' ORDER BY created_at DESC");
                ...
                <div class="flex flex-col h-full">
                  ...
                  <div class="flex flex-wrap gap-2 mb-6">
                    <span class="px-3 py-1 bg-blue-100 text-blue-600 rounded-full text-sm"
                      style="font-family: 'Kanit', sans-serif;">การ์ดเกม</span>
                  ...
                  <div class="mt-auto">
                    <div class="flex flex-wrap gap-6 text-gray-600">
                      <div class="flex items-center">
                        ...
                        <span style="font-family: 'Kanit', sans-serif;">เวลาในการเล่น: <?php echo htmlspecialchars($boardgame['play_time']); ?> นาที</span>
                      </div>
                      <div class="flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
