...
<head>
    ...
    <title>จัดการวิธีเล่นบอร์ดเกม - Board & Card Game</title>
    ...
    <div class="ml-64 p-8">
        ...
        <div class="flex justify-between items-center mb-8">
            ...
            <button onclick="showModal('boardgameModal')"
                ...
                <span style="font-family: 'Kanit', sans-serif;">เพิ่มวิธีเล่นบอร์ดเกมใหม่</span>
            </button>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    $stmt = $conn->query("SELECT * FROM how_to_play_boardgames ORDER BY created_at DESC");
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                <div class="font-medium text-gray-800" style="font-family: 'Kanit', sans-serif;">
                                    <?php echo htmlspecialchars($boardgame['name']); ?>
                                </div>
                            </td>
                            <td class="px-6 py-4 text-gray-600">
                                <?php echo htmlspecialchars($boardgame['player_min'] . '-' . $boardgame['player_max']); ?> คน
                            </td>
                            <td class="px-6 py-4 text-gray-600">
                                <?php echo htmlspecialchars($boardgame['age_rating']); ?>
                            </td>
                            <td class="px-6 py-4 text-gray-600">
                                <?php echo htmlspecialchars($boardgame['play_time']); ?>
                            </td>
                            <td class="px-6 py-4 text-gray-600">
                                <?php echo htmlspecialchars($boardgame['category']); ?>
                            </td>
                            <td class="px-6 py-4">
                                <span
            ...
            <div class="inline-block w-full max-w-4xl text-left align-middle transition-all transform bg-white rounded-xl shadow-2xl relative">
                <div class="p-8">
                    <h3 class="text-2xl font-bold text-gray-800 mb-6" style="font-family: 'Kanit', sans-serif;">
                        <span id="modalTitle">เพิ่มวิธีเล่นบอร์ดเกมใหม่</span>
                    </h3>

                    <form id="boardgameForm" action="./actions/save-how-to-play-boardgames.php" method="POST" enctype="multipart/form-data">
    ...
    <script>
        ...
        function showModal(modalId, boardgameId = null) {
            ...
            if (boardgameId) {
                ...
                fetch(`actions/get-how-to-play-boardgame.php?id=${boardgameId}`)
                    ...
                    .then(data => {
                        ...
                        document.getElementById('modalTitle').textContent = 'แก้ไขวิธีเล่นบอร์ดเกม';
                    });
            } else {
                document.getElementById('modalTitle').textContent = 'เพิ่มวิธีเล่นบอร์ดเกมใหม่';
            }
        }
        ...
        function confirmDelete(boardgameId) {
            if (confirm('คุณแน่ใจหรือไม่ที่จะลบวิธีเล่นบอร์ดเกมนี้?')) {
                window.location.href = `actions/delete-how-to-play-boardgame.php?id=${boardgameId}`;
            }
        }
    </script>
</body>
